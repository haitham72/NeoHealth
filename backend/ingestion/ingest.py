...
def main():
    ...
    # Shared with apply_manual_fixes.py, which re-runs it over the merged list so
    # hand-added documents participate too (see ingestion/supersession.py).
    by_code = resolve_supersession(parsed_documents)
